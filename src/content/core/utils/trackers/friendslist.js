...
const FRIENDS_DATA_KEY = 'ronet_friends_data';
...
async function fetchFriendsPage(userId, cursor = null) {
    try {
        ...
        console.error('RoNet: Failed to fetch friends list page', error);
        return null;
    }
}
...
async function fetchUserProfileData(userIds) {
    try {
        ...
        console.error('RoNet: Failed to fetch user profile data', error);
        return null;
    }
}
...
async function fetchTrustedFriendsStatus(userId, friendIds) {
    ...
    try {
        ...
        console.error('RoNet: Failed to fetch trusted friends status', error);
        return new Set();
    }
}
...
export async function updateFriendsList(userId) {
    ...
    try {
        ...
        console.log('RoNet: Friends list and timestamp updated in local storage for user', userId);
        return fullFriendsList;

    } catch (error) {
        console.error('RoNet: Failed to update friends list', error);
        return [];
    }
}
