...
export function createStyledInput({ id, label = '', placeholder = ' ' }) {
    ...
    container.className = 'ronet-catalog-input-wrapper';

    const inputBase = document.createElement('div');
    inputBase.className = 'ronet-catalog-input-base';
    ...
    input.className = 'ronet-catalog-input-field';
    ...
    labelElement.className = 'ronet-catalog-input-label';
    labelElement.textContent = label;

    const fieldset = document.createElement('fieldset');
    fieldset.setAttribute('aria-hidden', 'true');
    fieldset.className = 'ronet-catalog-input-fieldset';

    const legend = document.createElement('legend');
    legend.className = 'ronet-catalog-input-legend';
