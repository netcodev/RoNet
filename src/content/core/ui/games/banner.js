...
export function init() {
    ...
    const BANNER_ID = 'ronet-game-notice-banner';
    ...
    if (!window.GameBannerManager) {
        window.GameBannerManager = {
            addNotice: function (title, iconHtml = '', description = '') {
                ...
                entry.className = 'ronet-game-notice-entry';
                ...
                if (iconHtml) {
                    ...
                    if (svgElement) {
                        ...
                        iconContent = `<div class="ronet-game-notice-icon">${modifiedIconHtml}</div>`;
                    }
                }

                const textContainer = document.createElement('div');
                textContainer.className = 'ronet-game-notice-text-container';

                const titleDiv = document.createElement('div');
                titleDiv.className = 'ronet-game-notice-title';
                ...
                if (description) {
                    ...
                    descDiv.className = 'ronet-game-notice-description';
