...
export function showFriendListOverlay(friends, gameName) {
    ...
    friends.forEach(friend => {
        ...
        displayName.style.color = 'var(--ronet-main-text-color)';

        const username = document.createElement('span');
        username.textContent = `@${friend.username}`;
        username.style.fontSize = '14px';
        username.style.color = 'var(--ronet-secondary-text-color)';
        ...
        joinBtn.style.backgroundColor = 'var(--ronet-playbutton-color)';
