...
function renderDetails(container, dateStr, updates) {
    ...
    header.style.color = 'var(--ronet-main-text-color, inherit)';
    ...
    updates.forEach(update => {
        ...
        verSpan.style.color = 'var(--ronet-secondary-text-color)';
...
function _renderHeatmap(graphContainer, history, detailsContainer) {
    ...
    dayIndices.forEach((dayIndex, i) => {
        ...
        text.setAttribute("fill", "var(--ronet-secondary-text-color)");
    ...
    for (let w = 0; w < weeks; w++) {
        ...
        for (let d = 0; d < 7; d++) {
            ...
            if (count > 0) {
                rect.setAttribute("fill", "var(--ronet-playbutton-color)");
                let opacity = 0.4;
    ...
    lessText.setAttribute("fill", "var(--ronet-secondary-text-color)");
    ...
    const levels = [
        ...
        { fill: "var(--ronet-playbutton-color)", opacity: "0.4" },
        { fill: "var(--ronet-playbutton-color)", opacity: "0.6" },
        { fill: "var(--ronet-playbutton-color)", opacity: "0.8" },
        { fill: "var(--ronet-playbutton-color)", opacity: "1.0" }
    ];
    ...
    moreText.setAttribute("fill", "var(--ronet-secondary-text-color)");
...
export function createHeatmap(historyData, titleText = 'Update History') {
    ...
    container.className = 'ronet-heatmap-container';
    ...
    detailsContainer.className = 'ronet-heatmap-details';
