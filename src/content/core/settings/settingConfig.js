    ...
    Games: {
        ...
        settings: {
            ...
            recentServersEnabled: {
                ...
                type: 'checkbox',
                default: true,
                storageKey: 'ronet_server_history',
            },
            TotalServersEnabled: {
                label: 'Total Servers',
                description: [
                    'This shows the total amount of servers RoNet is tracking under that experience.',
                ],
                type: 'checkbox',
                default: true,
            },
                ...
                childSettings: {
                    ...
                    EnableServerUptime: {
                        ...
                        description: [
                            ...
                            'This works by RoNet tracking hundreds of thousands of servers in a database and then estimating the uptime.',
                        ],
                        type: 'checkbox',
                        default: true,
                    },
    ...
    Profile: {
        ...
        settings: {
            ...
            statusBubbleEnabled: {
                label: 'Status Bubble',
                description: [
                    'This allows you to set a status bubble that anyone with RoNet can see.',
                    'Also allows you to view other RoNet users status bubbles.',
                ],
            },
            ...
            RoNetBadgesEnable: {
                label: 'RoNet Badges',
                description: [
                    'Disabling this will hide any RoNet badges from profiles.',
                ],
                type: 'checkbox',
                default: true,
            },
    ...
    Avatar: {
        ...
        settings: {
            ...
            avatarRotatorEnabled: {
                ...
                default: true,
                storageKey: [
                    'ronet_avatar_rotator_enabled',
                    'ronet_avatar_rotator_ids',
                    'ronet_avatar_rotator_interval',
                ],
            },
        },
    },
    ...
    Navigation: {
        ...
        settings: {
            ...
            searchHistoryEnabled: {
                ...
                type: 'checkbox',
                default: true,
                storageKey: 'ronet_search_history',
            },
        },
    },
    Miscellaneous: {
        ...
        settings: {
            ...
            ServerdataEnabled: {
                label: "Send Server IDs and Place IDs to RoNet's API",
                description: [
                    "This feature sends server IDs and place IDs to RoNet's API when you browse the site.",
            ...
            firstAccountEnabled: {
                ...
                type: 'checkbox',
                default: true,
                storageKey: 'ronet_first_account_cache',
            },
            revertLogo: {
        ...
        settings: {
            streamermode: {
                ...
                childSettings: {
                    settingsPageInfo: {
                        ...
                        description: [
                            "This visually replaces your Email, Phone Number, Sessions and account location with 'RoNet Streamer Mode Enabled'",
            ...
            spoofAsStudio: {
                ...
                description: [
                    ...
                    'Joining an experience will overwrite this status.',
                    'The Spoofed Status will only show if RoNet is enabled and a Roblox page is open.',
                ],
                type: 'checkbox',
                default: false,
    ...
    Developer: {
        ...
        settings: {
            info: {
                ...
                description: [
                    "These are features used mostly to develop ronet, if you don't know what your doing dont touch them.",
                ],
                type: 'yay',
            },
            ...
            onboardingShown: {
                ...
                description: [
                    "This will show RoNet's onboarding screen again when this setting is disabled.",
                ],
                type: 'checkbox',
                default: false,
            },
            simulateRoNetServerErrors: {
                label: ['Simulate RoNet Server Errors / downtime'],
                description: [
                    'This will simulate RoNet Server errors / downtime, useful when testing how the extension handles stuff like that.',
                ],
                type: 'checkbox',
                default: false,
            },
            ...
            environmentTester: {
                ...
                childSettings: {
                    ...
                    generateJson: {
                        ...
                        event: 'ronet:generateEnvironmentJson',
                    },
                },
            },
        },
