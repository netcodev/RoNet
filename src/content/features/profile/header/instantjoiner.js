...
export function init() {
    chrome.storage.local.get({ userSniperEnabled: false, deeplinkEnabled: true }, function(settings) {
        ...
        function stopPresenceCheck() {
            ...
            document.querySelectorAll('.ronet-instant-join-button').forEach(btn => {
        ...
        function addInstantJoinButton(observedElement) {
            ...
            if (observedElement.querySelector('.ronet-instant-join-button')) {
                return;
            }
            ...
            button.classList.add('ronet-instant-join-button');
