...
const INACTIVE_MAIN_BUTTON_ID = 'ronet-bulk-inactivate-btn';
const SET_INACTIVE_BTN_ID = 'ronet-set-inactive-btn';
const ACTIVE_MAIN_BUTTON_ID = 'ronet-bulk-activate-btn';
const SET_ACTIVE_BTN_ID = 'ronet-set-active-btn';
const SELECT_ALL_BTN_ID = 'ronet-select-all-btn';

const FILTERED_LIST_ID = 'ronet-filtered-assets-list';
const PROGRESS_TEXT_ID = 'ronet-progress-text';
const PROGRESS_RESULTS_ID = 'ronet-progress-results';
const LOADING_SPINNER_ID = 'ronet-loading-spinner';
...
async function processServerRequest(selectedItems, isActive) {
    ...
    const iconUrl = assets.ronetIcon;
