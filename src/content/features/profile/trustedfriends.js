...
async function getProfileStatus(userId) {
    ...
    const statusPromise = (async () => {
        try {
            ...
            console.error('RoNet: Failed to fetch trusted friend status.', err);
        ...
        showConfirmationPrompt({
            ...
            onConfirm: () => {
                ...
                action().then(async () => {
                    ...
                    console.error('RoNet: Failed to send trusted friend request.', err);
        ...
        showConfirmationPrompt({
            ...
            onConfirm: () => {
                ...
                action().then(async () => {
                    ...
                    console.error('RoNet: Failed to accept trusted friend request.', err);
        ...
        showConfirmationPrompt({
            ...
            onConfirm: () => {
                ...
                action().then(async () => {
                    ...
                    console.error('RoNet: Failed to remove trusted friend.', err);
...
async function addTrustedFriendButton(menu) {
    if (menu.dataset.ronetTrustedFriendBtnAdded) {
        return;
    }
    menu.dataset.ronetTrustedFriendBtnAdded = 'true';
...
export function init() {
    chrome.storage.local.get({ trustedConnectionsEnabled: true }, (settings) => {
        ...
        observeElement('#user-profile-header-contextual-menu-button', (button) => {
            ...
            if (button.dataset.ronetTrustedListener) {
                return;
            }
            button.dataset.ronetTrustedListener = 'true';
