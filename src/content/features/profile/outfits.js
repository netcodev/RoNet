...
export function init() {
    chrome.storage.local.get('useroutfitsEnabled', function (data) {
        ...
        function createOutfitsOverlay(
            ...
            detailsPanel.className = 'ronet-outfit-details-panel';
            ...
            totalPriceElement.id = 'ronet-outfit-total-price';
            ...
            Object.assign(separator.style, {
                height: '1px',
                width: '90%',
                backgroundColor: 'var(--ronet-border-color)',
                margin: '10px auto',
            });
            const itemsContainer = document.createElement('div');
            itemsContainer.className = 'ronet-outfit-items-container';
            ...
            paginationContainer.className =
                'ronet-outfit-pagination-container';
            ...
            const selectOutfit = async (outfit, listItem) => {
                ...
                Object.assign(shimmerPlaceholder.style, {
                    ...
                    position: 'absolute',
                    borderRadius: '8px',
                    backgroundColor: 'var(--ronet-button-background-color)',
                });
                ...
                itemsContainer.innerHTML = safeHtml(`<p style="color: var(--ronet-secondary-text-color); font-style: italic; text-align: center;">Loading items...</p>`,);
                ...
                if (outfitDetailsCache.has(outfit.id)) {
                    ...
                    try {
                        ...
                        itemsContainer.innerHTML = DOMPurify.sanitize(
                            `<p style="color: var(--ronet-secondary-text-color); font-style: italic; text-align: center; margin-right: auto; margin-left: auto;">Could not load items.</p>`,
                        );
                    }
                }
        ...
        function addShowOutfitsButton(element) {
            ...
            if (
                !container ||
                container.querySelector('.ronet-show-outfits-btn')
            ) {
                return;
            }
            ...
            button.classList.add('ronet-show-outfits-btn');
