...
async function mountDependencyScanner(favButton) {
    if (favButton.dataset.ronetScanning === 'true') return;

    if (favButton.nextSibling?.id === 'ronet-dep-container' || document.getElementById('ronet-dep-container')) return;
    const parent = favButton.parentNode;
    if (!parent) return;

    favButton.dataset.ronetScanning = 'true';
    ...
    try {
        ...
        if (document.getElementById('ronet-dep-container')) return;

        const uiContainer = document.createElement('div');
        uiContainer.id = 'ronet-dep-container';
        ...
        contentWrapper.className = 'ronet-dep-panel-content';
        const grid = document.createElement('div');
        grid.className = 'ronet-dep-grid';
        ...
        console.warn('[Ronet Scanner] Silent failure:', error);
    }
}
