...
const STORAGE_KEY = 'ronet_groups_order';
...
function initializeDragSystem() {
    observeElement('a.groups-list-item', (link) => {
        ...
        if (container.hasAttribute('data-ronet-drag')) return;
        
        container.setAttribute('data-ronet-drag', 'true');
...
function createDropIndicator() {
    ...
    dropIndicator.style.backgroundColor = 'var(--ronet-playbutton-color)';
...
function destroyDragSystem() {
    const containers = document.querySelectorAll('.groups-list-items-container[data-ronet-drag]');
    containers.forEach(container => {
        container.removeAttribute('data-ronet-drag');
        const links = container.querySelectorAll('a.groups-list-item');
        links.forEach(link => {
