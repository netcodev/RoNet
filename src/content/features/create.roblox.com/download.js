...
async function downloadAsset(assetId) {
    ...
    try {
        ...
        console.error('[RoNet DL] Failed to fetch asset location:', e);
    }
    ...
    if (assetLocation) {
        try {
            ...
            console.error(`[RoNet DL] Failed to process raw asset:`, e);
        }
    }
...
function addButton(buttonContainer) {
    ...
    if (!assetId || document.getElementById('ronet-download-asset-btn')) {
        return;
    }
    ...
    downloadButton.id = 'ronet-download-asset-btn';
