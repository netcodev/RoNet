...
export function init() {
    ...
    function updateSettingsPage() {
        ...
        if (phoneField) {
            ...
            if (
                phoneValueSpan &&
                phoneValueSpan.textContent !== 'RoNet Streamer Mode Enabled'
            ) {
                phoneValueSpan.textContent = 'RoNet Streamer Mode Enabled';
            }
            ...
            (data) => {
                try {
                    if (data.streamermode) {
                        sessionStorage.setItem('ronet_streamermode', 'true');
                        sessionStorage.setItem(
                            'ronet_settingsPageInfo',
                        ...
                        sessionStorage.removeItem('ronet_streamermode');
                    }
                } catch (e) {}
                ...
                document.dispatchEvent(
                    new CustomEvent('ronet-streamer-mode', {
                        detail: {
