...
async function fetchUniverseId(placeId) {
    ...
    try {
        ...
        console.error('RoNet: Error fetching universe ID', error);
        return null;
    }
}
...
async function fetchDevProducts(universeId) {
    ...
    try {
        ...
        console.error('RoNet: Error fetching developer products', error);
        return allProducts;
    }
}

async function loadAndRenderProducts(storeTab, placeId) {
    if (storeTab.dataset.ronetDevProductsLoaded === 'true') return;
    storeTab.dataset.ronetDevProductsLoaded = 'true';
    ...
    devProductsList.className = 'hlist store-cards ronet-dev-products-container';
