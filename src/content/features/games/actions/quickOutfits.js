...
function createOutfitCard(outfit, thumbnailData, onSuccess) {
    ...
    Object.assign(thumbContainer.style, {
        ...
        overflow: 'hidden',
        marginBottom: '8px',
        backgroundColor: 'var(--ronet-container-background-color)',
        position: 'relative'
    });
...
async function showQuickOutfitsOverlay() {
    ...
    try {
        ...
        const updatePagination = () => {
            ...
            pageInfo.style.color = 'var(--ronet-secondary-text-color)';
...
function addQuickOutfitsButton(container) {
    if (container.querySelector('.ronet-quick-outfits-btn-container')) {
        return;
    }

    const buttonContainer = document.createElement('div');
    buttonContainer.className = 'ronet-quick-outfits-btn-container';
